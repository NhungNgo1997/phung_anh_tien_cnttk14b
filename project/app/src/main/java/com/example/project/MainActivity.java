...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClientInstance.API service = ClientInstance.getRetrofit().create(ClientInstance.API.class);
        Call<List<audio>> call = service.getdata();
        ...
        adapter = new Adapter(this,listAudio);
    ...
    private void generateDataList(List<audio> audio) {
        recyclerView = findViewById(R.id.ryc);
        adapter = new Adapter(this,audio);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(MainActivity.this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(adapter);
    }
